...
const About = () => {
    ...
    return (
        <main className="about" data-aos="fade-up">
            ...
            <img className="unicorn" src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/237/unicorn-face_1f984.png" alt="unicorn emoji"/>
            ...
            <div className="tools" data-aos="fade-up">
                <p>Some of my favorite UX designer tools:</p>
                <div className="tool">
                    <a href="https://www.sketch.com/">
                    <img src="/images/about/sketch.svg" alt="Sketch logo"/>
                    <p>Sketch</p>
                    </a>
                </div>
                <div className="tool">
                    <a href="https://www.figma.com/">
                    <img id="figma" src="/images/about/figma.svg" alt="Figma logo"/>
                    <p>Figma</p>
                    </a>
                </div>
                <div className="tool">
                    <a href="https://www.adobe.com/products/xd.html">
                    <img src="/images/about/adobe-xd-1.svg" alt="adobe xd logo"/>
                    <p>Adobe Xd</p>
                    </a>
                </div>
            </div>
